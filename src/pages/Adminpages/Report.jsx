...
export default function AdminReports({ user }) {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      // ADMIN route – no user_id
      const response = await fetch(`${API_BASE}/report/reportsadmin?${params}`);
  ...
  const handlePrint = () => {
    const printContent = document.getElementById("printable-report-admin");
    if (!printContent) {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Admin Sample Report - ${user?.first_name || ""} ${
      user?.last_name || ""
    }</title>
          <style>
            body { 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 mb-6 overflow-hidden">
          <div className="bg-gradient-to-r from-slate-900 to-slate-700 p-6 text-white">
            <div className="flex items-center gap-3 mb-2">
              <FileText size={32} />
              <h1 className="text-3xl font-bold">Admin Sample Report</h1>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-end">
                  <button
                    onClick={fetchReport}
                    disabled={loading}
                    className="w-full bg-slate-900 text-white px-6 py-2 rounded-lg hover:bg-slate-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                  >
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className="p-4 bg-slate-50 border-b border-gray-200 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handlePrint}
                className="bg-slate-900 text-white px-4 py-2 rounded-lg hover:bg-slate-800 flex items-center gap-2 transition-colors disabled:opacity-50"
          ...
          {reportData.length > 0 && (
            <div className="p-6 bg-slate-50 border-t border-gray-200 text-center">
              <p className="text-sm text-slate-600">
                End of Admin Report - LabTrack System ©{" "}
      ...
      {/* Hidden Printable Content for Admin */}
      <div id="printable-report-admin" style={{ display: "none" }}>
        <div className="header">
          <h1>Admin Sample Report</h1>
          <div
            style={{
              display: "grid",
